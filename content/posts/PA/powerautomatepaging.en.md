...
## Add a condition to check whether there is data
...
4. Increment the **`PageNumber`** variable by 1.
5. Set the **`MoreRecords`** variable to *true*.
6. Increment the **`RecordsCount`** variable by the length of the results array (`length(outputs('List_rows')?['body/value'])`).
