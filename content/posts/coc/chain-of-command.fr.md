...
final class CompanySalesFormLetter_PrefixCompany_Class_Extension
{
...
## Étendre une source de données du formulaire
...
## Étendre un champ de données sur un formulaire
...
## Étendre un contrôle de formulaire
