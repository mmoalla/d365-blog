...
# Steps
## Create a model mapping designer configuration
...
![](images/ER/part2/image2.png)
9. Select **SalesTable** table and enter a name *SalesTable*.
10. Click **OK**.
![](images/ER/part2/image3.png)

## Map data sources to data model
