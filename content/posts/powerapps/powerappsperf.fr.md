...
# Étapes
## Charger les jeux de données simultanément
...
![](images/powerapps/Image1.png)
 
## Mettre les données des tables en cache
...
![](images/powerapps/Image2.png)
![](images/powerapps/Image3.png)

## Limiter la taille d'une collection
Limitez le nombre de colonnes d'une collection et sélectionnez uniquement celles que vous utilisez dans l'application.
![](images/powerapps/Image4.png)

## Éffectuer les mises à jour en bloc
![](images/powerapps/Image5.png)
 
## Réduire les opérations effectuées au démarrage
