...
# Étapes
## Activer la fonctionnalité Code Apps
...
![](images/PPCodeApp/image1.png)

## Créer le squelette du projet à partir du modèle officiel
```bash
...
![](images/PPCodeApp/image2.png)

## S'authentifier et sélectionner l'environnement cible
