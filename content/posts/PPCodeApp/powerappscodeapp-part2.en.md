...
```ts {lineNos=true filename=useUserProfile.ts}
...
```tsx {lineNos=true filename=UserProfile.tsx}
...
```tsx {lineNos=true filename=App.tsx}
import './App.css'
...
![](images/PPCodeApp/image8.png)

The username, photo, and email are displayed.
![](images/PPCodeApp/image9.png)
