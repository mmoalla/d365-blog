...
# Étapes
## Créer le projet et la classe d'extension
...
## Identifier l'événement à intercepter
Ouvre la table `CustTable` dans l'Application Explorer et repère la méthode `confirmAndSaveCustGroupChange()`. 
...
## Ajouter une validation avec un Pre Event Handler
